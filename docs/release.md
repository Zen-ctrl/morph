...
## Git and private repository handoff

The user authorized a detailed private GitHub repository for this project. Before remote
creation or push:
...
4. Use private visibility.
5. Do not force-push or change another repository's visibility.
